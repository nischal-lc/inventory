...
const Overview = () => {
	return (
		<div className='  grid lg:grid-cols-4 md:grid-rows-none grid-rows-2 gap-3'>
			...
			<div className='border rounded-md px-4 py-5 lg:col-span-1'>
				...
				<div className="h-[350px]">
					<ChartContainer
						...
						className='mx-auto h-full w-full aspect-square pb-0'>
